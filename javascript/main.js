          ...
          <div class="container">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
              <ul class="navbar-nav menu-navbar-nav">
                ...
                <li class="nav-item">
                <a class="nav-link" href="blog.html">Videos</a>
              </li>
               
                <li class="nav-item">
                  <a class="nav-link" href="chat.html">ChatUs</a>
                </li>
                <li class="nav-item">
...
class MyFooter extends HTMLElement{
    ...
    <div class="container dipsy">
      <div class="row p-5">
        <div class="col-lg-3 col-md-3 col-sm-2 col-12">
          ...
          <strong class="mt-">Mail:dipeshsaini238@gmail.com</strong>
          <div class="row">
    ...
    <div class="copyright">
      <p>Copyright © 2023 Gibbon by Dipesh Saini</p>
